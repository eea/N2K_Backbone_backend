    ...
    public class SpeciesOther :IEntityModel, IEntityModelBackboneDB, IEntityModelBackboneDBHarvesting
    {
        ...
        public void SaveRecord(string db)
        {
            try
            {
                ...
                SqlParameter param3 = new SqlParameter("@SpecieCode", this.SpecieCode is null ? DBNull.Value : this.SpecieCode);
            ...
            {
                SystemLog.write(SystemLog.errorLevel.Error, ex, "SpeciesOther - SaveRecord", "");
            }
        }
        public static void SaveBulkRecord(string db, List<SpeciesOther> listData)
        {
            try
            {
                if (listData.Count > 0)
