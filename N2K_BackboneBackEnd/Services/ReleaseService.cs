...
namespace N2K_BackboneBackEnd.Services
{
    public class ReleaseService : IReleaseService
    {
        ...
        public async Task<List<BioRegionTypes>> GetUnionBioRegionTypes()
        {
            ...
            {
                SystemLog.write(SystemLog.errorLevel.Error, ex, "ReleaseService - GetUnionBioRegionTypes", "");
                throw ex;
            }
        }
        ...
        public async Task<List<Releases>> GetReleaseHeadersByBioRegion(string? bioRegionShortCode)
        {
            ...
            {
                SystemLog.write(SystemLog.errorLevel.Error, ex, "ReleaseService - GetReleaseHeadersByBioRegion", "");
                throw ex;
            }
        }
        ...
        public async Task<List<Releases>> ConvertUnionListHeaderListToReleases(List<UnionListHeader> unionListHeaders)
        {
            ...
            {
                SystemLog.write(SystemLog.errorLevel.Error, ex, "ReleaseService - ConvertUnionListHeaderListToReleases", "");
                throw ex;
            }
        }
        ...
        public async Task<Releases> ConvertUnionListHeaderToReleases(UnionListHeader unionListHeader)
        {
            ...
            {
                SystemLog.write(SystemLog.errorLevel.Error, ex, "ReleaseService - ConvertUnionListHeaderToReleases", "");
                throw ex;
            }
        }
        ...
        public async Task<List<ReleaseDetail>> GetCurrentSitesReleaseDetailByBioRegion(string? bioRegionShortCode)
        {
            ...
            {
                SystemLog.write(SystemLog.errorLevel.Error, ex, "ReleaseService - GetCurrentSitesReleaseDetailByBioRegion", "");
                throw ex;
            }
        }
        ...
        public async Task<List<Releases>> GetReleaseHeadersById(long? id)
        {
            ...
            {
                SystemLog.write(SystemLog.errorLevel.Error, ex, "ReleaseService - GetReleaseHeadersById", "");
                throw ex;
            }
        }
        ...
        private async Task<List<BioRegionSiteCode>> GetBioregionSiteCodesInReleaseComparer(long? idSource, long? idTarget, string? bioRegions, IMemoryCache cache)
        {
            ...
            {
                SystemLog.write(SystemLog.errorLevel.Error, ex, "ReleaseService - GetBioregionSiteCodesInReleaseComparer", "");
                throw ex;
            }
        }
        ...
        public async Task<UnionListComparerSummaryViewModel> GetCompareSummary(long? idSource, long? idTarget, string? bioRegions, IMemoryCache cache)
        {
            ...
            {
                SystemLog.write(SystemLog.errorLevel.Error, ex, "ReleaseService - GetCompareSummary", "");
                throw ex;
            }
        }
        ...
        public async Task<List<UnionListComparerDetailedViewModel>> CompareReleases(long? idSource, long? idTarget, string? bioRegions, string? country, IMemoryCache cache, int page = 1, int pageLimit = 0)
        {
            ...
            {
                SystemLog.write(SystemLog.errorLevel.Error, ex, "ReleaseService - CompareReleases", "");
                throw ex;
            }
        }
        ...
        public async Task<List<Releases>> CreateRelease(string title, Boolean? isOfficial, string? character, string? comments)
        {
            ...
            {
                SystemLog.write(SystemLog.errorLevel.Error, ex, "ReleaseService - CreateRelease", "");
                throw ex;
            }
        }
        ...
        public async Task<List<Releases>> UpdateRelease(long id, string name, Boolean final)
        {
            ...
            {
                SystemLog.write(SystemLog.errorLevel.Error, ex, "ReleaseService - UpdateRelease", "");
                throw ex;
            }
        }
        ...
        public async Task<int> DeleteRelease(long id)
        {
            ...
            {
                SystemLog.write(SystemLog.errorLevel.Error, ex, "ReleaseService - DeleteRelease", "");
                throw ex;
            }
        }
