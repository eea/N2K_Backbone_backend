...
namespace N2K_BackboneBackEnd.Services
{
    ...
    public class SiteDetailsService : ISiteDetailsService
    {
        ...
        public async Task<SiteGeometryDetailed> GetSiteGeometry(string siteCode, int version)
        {
            ...
            {
                await SystemLog.WriteAsync(SystemLog.errorLevel.Error, ex, "SiteDetailsService - GetSiteGeometry", "", _dataContext.Database.GetConnectionString());
                throw ex;
            }
        }
        #endregion 
        ...
        public async Task<List<StatusChanges>> ListSiteComments(string pSiteCode, int pCountryVersion, IMemoryCache cache, bool temporal = false)
        {
            ...
            {
                await SystemLog.WriteAsync(SystemLog.errorLevel.Error, ex, "SiteDetailsService - ListSiteComments", "", _dataContext.Database.GetConnectionString());
                throw ex;
            }
        }
        ...
        public async Task<List<JustificationFiles>> ListSiteFiles(string pSiteCode, int pCountryVersion, IMemoryCache cache, bool temporal = false)
        {
            ...
            {
                await SystemLog.WriteAsync(SystemLog.errorLevel.Error, ex, "SiteDetailsService - ListSiteFiles", "", _dataContext.Database.GetConnectionString());
                throw ex;
            }
        }
        ...
        public async Task<List<JustificationFiles>> UploadFile(AttachedFile attachedFile, IMemoryCache cache, bool temporal = false)
        {
            ...
            {
                await SystemLog.WriteAsync(SystemLog.errorLevel.Error, ex, "SiteDetailsService - UploadFile", "", _dataContext.Database.GetConnectionString());
                throw ex;
            }
        }
        ...
        public async Task<int> DeleteFile(long justificationId, IMemoryCache cache, bool temporal = false)
        {
            ...
            {
                await SystemLog.WriteAsync(SystemLog.errorLevel.Error, ex, "SiteDetailsService - DeleteFile", "", _dataContext.Database.GetConnectionString());
                throw ex;
            }
        }
        #endregion
        ...
        public async Task<string> SaveEdition(ChangeEditionDb changeEdition, IMemoryCache cache)
        {
            ...
            {
                await SystemLog.WriteAsync(SystemLog.errorLevel.Error, string.Format("The version for this Site doesn't exist (" + changeEdition.SiteCode + " - " + changeEdition.Version.ToString() + ") {0}", iex.Message), "SaveEdition", "", _dataContext.Database.GetConnectionString());
                throw new Exception("The version for this Site doesn't exist (" + changeEdition.SiteCode + " - " + changeEdition.Version.ToString() + ")");
            }
            catch (Exception ex)
            {
                await SystemLog.WriteAsync(SystemLog.errorLevel.Error, ex, "SiteDetailsService - SaveEdition", "", _dataContext.Database.GetConnectionString());
                throw ex;
            }
        ...
        public async Task<ChangeEditionViewModelOriginalExtended?> GetReferenceEditInfo(string siteCode)
        {
            ...
            {
                await SystemLog.WriteAsync(SystemLog.errorLevel.Error, ex, "SiteDetailsService - GetReferenceEditInfo", "", _dataContext.Database.GetConnectionString());
                throw ex;
            }
        }
        #endregion
